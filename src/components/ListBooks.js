    ...
    return (
      <div className="list-books">
        ...
        <div className="list-books-content">
          <Bookshelf
            shelfID={this.state.shelfs["1"]}
            bookshelfTitle={this.state.shelfs["1"]}
            books={this.state.books}
          />
          <Bookshelf
            shelfID={this.state.shelfs["2"]}
            bookshelfTitle={this.state.shelfs["2"]}
            books={this.state.books}
          />
          <Bookshelf
            shelfID={this.state.shelfs["3"]}
            bookshelfTitle={this.state.shelfs["3"]}
            books={this.state.books}
          />
        </div>
